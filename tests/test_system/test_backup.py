...
# from tests.server import KEEP_SERVER, data_folder, minecraft_create, wait_server


# @pytest.mark.skipif(KEEP_SERVER, reason="KEEP_SERVER incompatible with backup")
# def test_backup_restore(minecraft_client: Client, tmp_path: Path):
#     """
...
#     # create a new server and draw its world data from the backup
#     # overwrite the backed up change in the world
#     result = minecraft_client.setblock(test_block, Item.YELLOW_CONCRETE.value)
#     logging.debug("setblock %s", result)
